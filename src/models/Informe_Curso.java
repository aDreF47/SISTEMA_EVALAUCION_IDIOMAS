...
public class Informe_Curso {
    ...
    public Informe_Curso() {}

    public Informe_Curso(int idInforme, String idCurso, LocalDateTime fechaGeneracion, double puntajePromedio, int totalEstudiantes, double tasaCompletitud) {
