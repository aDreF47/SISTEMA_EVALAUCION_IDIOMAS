...
public class Profesor {
    ...
    public Profesor(short idProfesor, String codigo, String nombre, String apellidoPaterno, 
    ...
    public short getIdProfesor() {
        return idProfesor;
    }

    public void setIdProfesor(short idProfesor) {
        if (idProfesor > 0) {
